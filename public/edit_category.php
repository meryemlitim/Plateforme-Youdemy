...
<div class="fixed inset-0 p-4 flex flex-wrap justify-center items-center w-full h-full z-[1000] before:fixed before:inset-0 before:w-full before:h-full before:bg-[rgba(0,0,0,0.5)] overflow-auto font-[sans-serif]">
        <div class="w-full max-w-lg bg-white shadow-lg rounded-lg p-8 relative">
            <div class="flex items-center">
                <h3 class="text-blue-600 text-3xl font-bold flex-1 text-center w-full">EDIT CATEGORY</h3>
            ...
            <form class="space-y-4 mt-8" action="" method="post" autocomplete="off">
                ...
                <div class="flex justify-end gap-4 !mt-8">
                    <button type="button" id="ajouteCancelQuiz"
                        ...
                        <!-- <input type="text" value="<?= $update_category["id_category"]?>"> -->
                    <button type="submit" name="update_category" value="<?= $update_category["id_category"]?>"
                        class="px-6 py-3 rounded-lg text-white text-sm border-none outline-none tracking-wide bg-blue-600 hover:bg-blue-700">Update</button>
                </div>
