    ...
    <div class="relative bg-[#f7f6f9] h-full min-h-screen font-[sans-serif]">
      <div class="flex items-start">
       <?php include "../template/teacher_sidebare.php" ?>
        ...
        <!-- ---------------------------------add courses-------------------------------- -->
        <section id="<section id="tag" class="flex flex-col items-center bg-gray-50 min-h-screen p-6 hidden">
                    <!-- Header -->
                ...
                </section>" class="flex flex-col items-center bg-gray-50 min-h-screen p-6 hidden">
                    <!-- Header -->
                    <div class="w-full max-w-7xl bg-white shadow-lg rounded-lg p-6 space-y-6">
                        <div class="flex justify-between items-center">
                            <h1 class="text-3xl font-bold text-gray-800 flex items-center gap-2">
