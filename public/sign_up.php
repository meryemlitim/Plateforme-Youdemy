...
<body class="bg-[url('')] bg-blue-600 bg-cover bg-no-repeat h-screen">
                ...
                <div class="p-8 rounded-2xl bg-white shadow">
                    ...
                    <form class="mt-8 space-y-4" method="post" autocomplete="off">
                        ...
                        <div class="w-full">
                            ...
                            <div class="relative flex items-center">
                                <select name="role" id="role" required class="w-full text-gray-800 text-sm border border-gray-300 px-4 py-3 rounded-md outline-orange-600">
                        ...
                        <div class="!mt-8">
                            <button type="submit" name="submit" class="w-full py-3 px-4 text-sm tracking-wide rounded-lg text-white bg-blue-600 hover:bg-blue-700 focus:outline-none">
                                Sign Up
                            </button>
                        </div>
